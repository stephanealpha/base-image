...
CHECKPOINT_MODELS=(
    ...
    "https://civitai.com/api/download/models/1899516?type=Model&format=SafeTensor&size=pruned&fp=fp16"
    "https://civitai.com/api/download/models/1906687?type=Model&format=SafeTensor&size=pruned&fp=fp16"
)
